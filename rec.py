...
NGROK_AUTH_TOKEN = "2qldp2U02Z6b55rgz2ACP94wo72_5XY5RnZLGqqRuNenvCbHW"  # Replace with your actual ngrok auth token
...
# Save the ngrok public URL to a .txt file for reference
...
if __name__ == '__main__':
    print(f"Server running at public URL: {public_url}/receive_attack")
    app.run(port=5000)
